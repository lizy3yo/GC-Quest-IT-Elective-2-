  ...
  return (
    <div
      ...
      className={`
        ...
        ${
          isExiting 
            ? 'opacity-0 translate-x-full scale-95 transition-all duration-300 ease-in' 
            : isEntering
            ? 'opacity-0 translate-x-8 scale-95 transition-none'
            : 'opacity-100 translate-x-0 scale-100 transition-all duration-300 ease-out'
        }
      `}
    >
