    ...
    showConfirm(
      ...
      async () => {
        ...
        try {
          ...
          router.push("/teacher_page/library");
        } catch (e: unknown) {
        ...
        <div style={{ maxWidth: '72rem', marginLeft: 'auto', marginRight: 'auto' }}>
          ...
          <div className="relative bg-white dark:bg-slate-800 rounded-3xl shadow-2xl border-2 border-slate-200 dark:border-slate-700 p-8 mb-8 overflow-hidden animate-pulse">
            ...
            <div className="relative">
              ...
              <div className="h-5 bg-slate-200 dark:bg-slate-700 rounded-lg w-24 mb-4"></div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-2xl border-2 border-slate-200 dark:border-slate-700 p-8 mb-8 animate-pulse">
            ...
            <div className="bg-slate-50 dark:bg-slate-700/50 rounded-2xl p-8 mb-6 min-h-[200px] flex items-center justify-center">
              <div className="text-center w-full">
                <div className="h-6 bg-slate-200 dark:bg-slate-600 rounded w-3/4 mx-auto mb-4"></div>
                <div className="h-4 bg-slate-200 dark:bg-slate-600 rounded w-1/2 mx-auto"></div>
              </div>
            </div>
          ...
          {/* Cards List Skeleton */}
          <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-2xl border-2 border-slate-200 dark:border-slate-700 p-8 animate-pulse">
            <div className="flex items-center justify-between mb-6">
            ...
            <div className="space-y-4">
              {[1, 2, 3].map((i) => (
                <div key={i} className="bg-slate-50 dark:bg-slate-700/50 rounded-2xl p-5 border-2 border-slate-200 dark:border-slate-600">
                  <div className="h-5 bg-slate-200 dark:bg-slate-600 rounded w-full mb-3"></div>
    ...
    return (
      <div className="min-h-screen bg-slate-50 dark:bg-slate-900 p-6 transition-colors duration-300">
        <div className="max-w-4xl mx-auto">
          ...
          <button
            onClick={() => router.push("/teacher_page/library")}
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900" style={{ padding: '1.5rem' }}>
      <div style={{ maxWidth: '72rem', marginLeft: 'auto', marginRight: 'auto' }}>
          ...
          <div className="relative">
            ...
            <button
              onClick={() => {
                ...
                router.push(`/teacher_page/library?tab=${tab}`);
              }}
              className="inline-flex items-center gap-2 text-slate-600 dark:text-slate-400 hover:text-[#2E7D32] dark:hover:text-[#4CAF50] mb-4 transition-colors"
            ...
            {/* Metadata */}
            <div className="flex flex-wrap items-center gap-3 mb-6">
              <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300 rounded-lg font-semibold">
                <FileStack className="w-4 h-4" />
                Flashcards
              </span>
              <span className="inline-flex items-center px-3 py-1.5 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300 rounded-full text-sm font-semibold">
                {flashcard.cards.length} cards
              </span>
              {flashcard.difficulty && (
                <span className={`px-2.5 py-1 rounded-lg font-semibold text-sm ${
                  flashcard.difficulty === 'easy' ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300' :
                  flashcard.difficulty === 'medium' ? 'bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-300' :
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              >
                <Star className="w-4 h-4" fill={flashcard.isFavorite ? 'currentColor' : 'none'} />
                {flashcard.isFavorite ? 'Favorited' : 'Favorite'}
              </button>
        ...
        <div className="space-y-8">
          {/* Set Preview Section */}
          <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-2xl border-2 border-slate-200 dark:border-slate-700 p-8 relative overflow-hidden">
            ...
            <div className="relative">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                ...
                <div className="flex items-center gap-3">
                  <span className="text-sm font-medium text-slate-500 dark:text-slate-400">
                    {Math.min(viewerIndex + 1, flashcard.cards.length)} / {flashcard.cards.length}
                  </span>
                  <button
                    onClick={() => {
                      setViewerIndex(0);
                    ...
                    className="p-2.5 bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-300 rounded-xl hover:bg-[#2E7D32]/10 hover:text-[#2E7D32] dark:hover:text-[#4CAF50] transition-all"
              ...
              <div className="relative mb-6">
                <button
                  ...
                  className="w-full h-64 sm:h-72 lg:h-80 bg-slate-50 dark:bg-slate-700/50 border-2 border-slate-200 dark:border-slate-600 rounded-2xl shadow-lg hover:shadow-xl hover:border-[#2E7D32]/30 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#2E7D32] focus:ring-offset-2 dark:focus:ring-offset-slate-800"
                >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
              ...
              <button
                onClick={() => setIsShowingAnswer((s) => !s)}
                className="px-6 py-2.5 bg-[#2E7D32] text-white rounded-xl hover:bg-[#1B5E20] text-sm font-semibold shadow-md hover:shadow-lg transition-all"
              >
          ...
          <div className="relative">
            ...
            {flashcard.cards.length === 0 ? (
              <div className="text-center py-12 bg-slate-50 dark:bg-slate-700/50 rounded-2xl border-2 border-dashed border-slate-200 dark:border-slate-600">
                ...
                <button 
                  onClick={startAddingCard}
                  className="px-6 py-3 bg-[#2E7D32] text-white rounded-xl hover:bg-[#1B5E20] font-semibold shadow-md hover:shadow-lg transition-all"
                >
                  Add Your First Card
                </button>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                {flashcard.cards.map((card, index) => (
                  <div
                    key={card._id}
                    className="relative group bg-slate-50 dark:bg-slate-700/50 rounded-2xl p-5 border-2 border-slate-200 dark:border-slate-600 hover:border-[#2E7D32]/30 hover:shadow-xl transition-all"
                  >
