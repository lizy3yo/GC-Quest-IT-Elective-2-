...
export default function FlashcardOnlyPage() {
  ...
  const gotoNextDeck = () => {
    // Navigate back to teacher library where user can pick next deck
    router.push("/teacher_page/library");
  };

  const exploreRelated = () => {
    // Navigate to teacher library (explore) page
    router.push("/teacher_page/library");
  };
              ...
              onClick={() => {
                try {
                  ...
                  if (p.includes('/private_library/')) {
                    router.push('/teacher_page/private_library');
                    return;
                  }
                  if (p.includes('/public_library/')) {
                    router.push('/teacher_page/public_library');
                    return;
                  }
                } catch (e) {
