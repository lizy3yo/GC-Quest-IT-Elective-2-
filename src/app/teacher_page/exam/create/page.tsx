  ...
  const handleSaveExam = async (publish: boolean = false) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        showSuccess(publish ? "Exam published successfully!" : "Exam saved as draft");
        router.push(`/teacher_page/exam/${data.data._id}`);
      } else {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-400">Design comprehensive exams with advanced security</p>
              </div>
            </div>
          ...
          <div className="p-6">
            ...
            {activeTab === "basic" && (
              <div className="space-y-6">
                ...
                <div>
                  <label className="block text-sm font-semibold mb-2">Exam Instructions</label>
                  <textarea
                    value={instructions}
