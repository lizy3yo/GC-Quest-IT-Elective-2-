...
export default function QuizStudentSubmissionPage() {
  ...
  useEffect(() => {
    console.log('🎯 NEW ROUTE - Quiz Student Submission Page loaded', { examId, studentId });
    if (examId && studentId) {
  ...
  const loadQuizAndSubmission = async () => {
    try {
      ...
      if (submissionRes.ok) {
        ...
        console.log('📊 Deadline Exam - Submission data received:', submissionData);
        if (submissionData.success) {
          let sub = submissionData.data.submission;
          console.log('🔍 Deadline Exam - Tab switching data from individual endpoint:', {
          ...
          if (sub.tabSwitches === undefined) {
            console.log('⚠️ Deadline Exam - Tab switching data missing, fetching from submissions list...');
            ...
            if (submissionsRes.ok) {
              ...
              console.log('📋 Deadline Exam - All submissions:', allSubmissions.map((s: any) => ({
                id: s._id,
              ...
              if (!matchingSubmission) {
                ...
                console.log('🔍 Deadline Exam - Using any submission from student:', matchingSubmission);
              }
              
              if (matchingSubmission) {
                console.log('✅ Deadline Exam - Found tab switching data:', {
                ...
                console.log('❌ Deadline Exam - No matching submission found for student:', studentId);
              }
            }
          } else {
            console.log('✅ Deadline Exam - Tab switching data already present:', {
              tabSwitches: sub.tabSwitches,
              tabSwitchDurations: sub.tabSwitchDurations,
              totalAwayMs: sub.totalAwayMs
            });
