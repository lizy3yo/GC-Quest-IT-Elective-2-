                          ...
                          <div className="text-right">
                            ...
                            {submission.timeTaken && (
                              <div className="text-xs text-slate-500">
                                ⏱️ {Math.floor(submission.timeTaken / 60)}m {submission.timeTaken % 60}s
                              </div>
                            )}
                          </div>
                        </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 bg-white dark:bg-slate-800 rounded-lg">
                      <div>
                        ...
                        <div className="text-sm text-slate-600 dark:text-slate-400">
                          {exam.isLocked ? "🔒 Exam is locked - students cannot access" : "🔓 Exam is unlocked - students can access"}
                        </div>
                      </div>
                      <button
                      ...
                      >
                        {exam.isLocked ? "🔓 Unlock Now" : "🔒 Lock Now"}
                      </button>
                    </div>
                    
                    <div className="p-4 bg-white dark:bg-slate-800 rounded-lg">
                      <div className="font-semibold mb-2">📅 Schedule Auto-Unlock (Live Date)</div>
                      ...
                      {exam.scheduledOpen && (
                        <div className="mt-2 text-sm text-green-600 dark:text-green-400">
                          🔓 Will unlock: {new Date(exam.scheduledOpen).toLocaleString()}
                        </div>
                      )}
                    </div>
                    
                    <div className="p-4 bg-white dark:bg-slate-800 rounded-lg">
                      <div className="font-semibold mb-2">🔒 Schedule Auto-Lock (Deadline)</div>
                      <div className="text-sm text-slate-600 dark:text-slate-400 mb-3">
                      ...
                      {exam.scheduledClose && (
                        <div className="mt-2 text-sm text-red-600 dark:text-red-400">
                          🔒 Will lock: {new Date(exam.scheduledClose).toLocaleString()}
                        </div>
                      )}
                    </div>
                    
                    <div className="p-4 bg-white dark:bg-slate-800 rounded-lg">
                      <div className="font-semibold mb-2">✅ Pass Rate</div>
                      <div className="text-sm text-slate-600 dark:text-slate-400 mb-3">
