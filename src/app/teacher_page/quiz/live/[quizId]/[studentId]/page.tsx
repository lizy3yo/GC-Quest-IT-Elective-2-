  ...
  const loadQuizAndSubmission = async () => {
    try {
      ...
      if (submissionRes.ok) {
        ...
        console.log('📊 Live quiz - Submission data received:', submissionData);
        if (submissionData.success) {
          let sub = submissionData.data.submission;
          console.log('🔍 Live quiz - Tab switching data from individual endpoint:', {
          ...
          if (sub.tabSwitches === undefined) {
            console.log('⚠️ Live quiz - Tab switching data missing, fetching from submissions list...');
            ...
            if (submissionsRes.ok) {
              ...
              console.log('📋 Live quiz - All submissions:', allSubmissions.map((s: any) => ({
                id: s._id,
              ...
              if (!matchingSubmission) {
                ...
                console.log('🔍 Live quiz - Using any submission from student:', matchingSubmission);
              }
              
              if (matchingSubmission) {
                console.log('✅ Live quiz - Found tab switching data:', {
                ...
                console.log('❌ Live quiz - No matching submission found for student:', studentId);
              }
            }
          } else {
            console.log('✅ Live quiz - Tab switching data already present:', {
              tabSwitches: sub.tabSwitches,
              tabSwitchDurations: sub.tabSwitchDurations,
              totalAwayMs: sub.totalAwayMs
            });
