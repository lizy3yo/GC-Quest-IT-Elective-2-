    ...
    return (
      <div className="min-h-screen bg-slate-50 dark:bg-slate-900 transition-colors duration-300 p-6">
        <div className="max-w-6xl mx-auto">
          {/* Header Skeleton */}
          <div className="bg-white dark:bg-slate-800 rounded-3xl p-8 mb-8 border-2 border-slate-200 dark:border-slate-700 animate-pulse">
            <div className="flex items-center justify-between">
              <div>
                <div className="h-12 bg-slate-200 dark:bg-slate-700 rounded w-80 mb-3"></div>
                <div className="h-6 bg-slate-200 dark:bg-slate-700 rounded w-64"></div>
              </div>
              <div className="h-12 bg-slate-200 dark:bg-slate-700 rounded-xl w-24"></div>
            </div>
          </div>

          {/* Game Mode Skeleton */}
          <div className="bg-white dark:bg-slate-800 rounded-3xl p-8 mb-8 border-2 border-slate-200 dark:border-slate-700 animate-pulse">
            <div className="h-8 bg-slate-200 dark:bg-slate-700 rounded w-56 mb-6"></div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="p-6 bg-slate-100 dark:bg-slate-700/50 rounded-2xl">
                  <div className="w-16 h-16 bg-slate-200 dark:bg-slate-600 rounded-full mx-auto mb-3"></div>
                  <div className="h-6 bg-slate-200 dark:bg-slate-600 rounded w-24 mx-auto mb-2"></div>
                  <div className="h-4 bg-slate-200 dark:bg-slate-600 rounded w-20 mx-auto"></div>
                </div>
              ))}
            </div>
          </div>

          {/* Quiz Selection Skeleton */}
          <div className="bg-white dark:bg-slate-800 rounded-3xl p-8 mb-8 border-2 border-slate-200 dark:border-slate-700 animate-pulse">
            <div className="h-8 bg-slate-200 dark:bg-slate-700 rounded w-40 mb-6"></div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="p-6 bg-slate-100 dark:bg-slate-700/50 rounded-2xl">
                  <div className="flex items-start justify-between mb-3">
                    <div className="w-12 h-12 bg-slate-200 dark:bg-slate-600 rounded-lg"></div>
                    <div className="h-6 bg-slate-200 dark:bg-slate-600 rounded-full w-24"></div>
                  </div>
                  <div className="h-6 bg-slate-200 dark:bg-slate-600 rounded w-48 mb-2"></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[1, 2].map((col) => (
                <div key={col} className="space-y-4">
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="p-4 bg-slate-100 dark:bg-slate-700/50 rounded-xl flex items-center justify-between">
                      <div>
                      ...
                      <div className="w-14 h-7 bg-slate-200 dark:bg-slate-600 rounded-full"></div>
                    </div>
                  ))}
                </div>
              ))}
